...
CREATE TABLE IF NOT EXISTS deals(
 ...
 holding_costs REAL NOT NULL DEFAULT 0, buyer_price REAL NOT NULL DEFAULT 0,
 mao REAL NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'Analyzing', created_at TEXT NOT NULL
);
